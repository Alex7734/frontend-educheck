...
const FileDrop = ({ onFileSubmit }: {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-400 rounded-lg bg-white hover:bg-gray-100 cursor-pointer">
      ...
      />
      <label htmlFor="file_input" className="flex flex-col items-center justify-center space-y-2 cursor-pointer">
        <p className="text-gray-700 text-lg">Drag 'n' drop your CV here, or click to select files</p>
        <button
          id="file_input"
